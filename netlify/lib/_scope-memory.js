  ...
  const api = {
    ...
    async insertEvenement(row){
      ...
      const item = {
        ...
        heure_debut: row.heure_debut || row.heureDebut || row.heure_debut_prevue || row.heureDebutPrevue || null,
        heure_fin: row.heure_fin || row.heureFin || row.heure_fin_prevue || row.heureFinPrevue || null,
        heure_debut_prevue: row.heure_debut_prevue || row.heureDebutPrevue || row.heure_debut || row.heureDebut || null,
        heure_fin_prevue: row.heure_fin_prevue || row.heureFinPrevue || row.heure_fin || row.heureFin || null,
        heure_debut_reelle: row.heure_debut_reelle || row.heureDebutReelle || row.heure_debut_prevue || row.heureDebutPrevue || row.heure_debut || row.heureDebut || null,
