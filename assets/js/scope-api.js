...
(function (root, factory) {
  ...
  function createHttpClient(options) {
    ...
    return {
      ...
      modifierEncadrement(id, body, baseVersion) { return request('POST', `/evenements/${encodeURIComponent(id)}/encadrement/modifier`, withBaseVersion(body, baseVersion)); },
      ...
      reactiver(id, motif, baseVersion) { return request('POST', `/evenements/${encodeURIComponent(id)}/reactiver`, withBaseVersion({ motif }, baseVersion)); },
      desassigner(id, baseVersion) { return request('POST', `/evenements/${encodeURIComponent(id)}/desassigner`, withBaseVersion({}, baseVersion)); },
      ...
      annualCatalogReadiness() { return request('GET', '/annual-catalog/readiness'); },
      annualCatalog(params) { return request('GET', `/annual-catalog${queryString(params || {})}`); },
      ...
      previewAnnualCatalogImport(body) { return request('POST', '/annual-catalog/import/preview', body || {}); },
      ...
      previewAnnualRequirement(id) { return request('GET', `/annual-catalog/requirements/${encodeURIComponent(id)}/quo-vadis-preview`); },
      ...
      createQuoVadisCursus(body) { return request('POST', '/quo-vadis/cursus', body || {}); },
      updateQuoVadisCursus(id, body) { return request('PATCH', `/quo-vadis/cursus/${encodeURIComponent(id)}`, body || {}); },
      deleteQuoVadisCursus(id) { return request('DELETE', `/quo-vadis/cursus/${encodeURIComponent(id)}`); },
      createQuoVadisModule(id, body) { return request('POST', `/quo-vadis/cursus/${encodeURIComponent(id)}/modules`, body || {}); },
      updateQuoVadisModule(id, body) { return request('PATCH', `/quo-vadis/cursus/modules/${encodeURIComponent(id)}`, body || {}); },
      deleteQuoVadisModule(id) { return request('DELETE', `/quo-vadis/cursus/modules/${encodeURIComponent(id)}`); },
      reorderQuoVadisModules(id, stepIds) { return request('PATCH', `/quo-vadis/cursus/${encodeURIComponent(id)}/modules/order`, { stepIds }); },
      createQuoVadisRule(body) { return request('POST', '/quo-vadis/rules', body || {}); },
      updateQuoVadisRule(id, body) { return request('PATCH', `/quo-vadis/rules/${encodeURIComponent(id)}`, body || {}); },
      deleteQuoVadisRule(id) { return request('DELETE', `/quo-vadis/rules/${encodeURIComponent(id)}`); },
      ...
      setQuoVadisCursusStepSchedule(annee, body) { return request('POST', `/quo-vadis/programmes/${encodeURIComponent(annee || 2027)}/cursus-step-schedule`, body || {}); },
      ...
      async generateStatComReport(body) {
        const headers = { Accept: 'application/pdf', 'Content-Type': 'application/json' };
        let response;
        try {
          response = await fetchWithAuthRetry(`${base}/reports/statcom`, {
            method: 'POST',
            headers,
            body: JSON.stringify(body || {})
          });
