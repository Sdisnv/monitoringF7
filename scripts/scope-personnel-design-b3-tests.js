...
const { evaluateEligibility, TYPES_PERIODE, MOTIFS_INDISPONIBLE } = require('../netlify/functions/_scope-personnel');
...
(async () => {
  ...
  await record('08 — Gérer les affectations / clôture / UX / erreurs uniques', async () => {
    ...
    assert.ok(html.includes('scope-personnel-design-b3'));
