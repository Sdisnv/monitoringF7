...
(async () => {
  ...
  await record('11 — libellé écran et cache-bust', () => {
    ...
    assert.ok(html.includes('scope-objectifs-participation-1') || html.includes('scope-personnel-design-b4-r1') || html.includes('scope-events-multisession-1') || html.includes('scope-multisession-report-1'));
  });
