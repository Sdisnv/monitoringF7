...
(async () => {
  ...
  await record('08 — protections et performance R3 préservées', () => {
    ...
    ok(html.includes('scope-referentials-actions-ui-lifecycle-repair-5-2') || html.includes('scope-event-configuration-binding-ux-repair-4') || html.includes('scope-configuration-formation-ux-referentials-finish-5'), 'cache-buster SCOPE récent');
  });
