...
(async () => {
  await record('01 - cause racine: client API admin-users cache-buste', async () => {
    ...
    assert.ok(htmlSource.includes('scope-api.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope-api.js?v=scope-admin-users-availability-repair-1') || htmlSource.includes('scope-api.js?v=scope-participation-policy-engine-1'));
