...
(async () => {
  ...
  await record('07 administration Participation, schema et cache-bust sont presents', () => {
    ...
    assert.ok(htmlSource.includes('scope-ui-logic.js?v=scope-configuration-formation-ux-import-performance-repair-2') || htmlSource.includes('scope-ui-logic.js?v=scope-generic-event-session-policy-architecture-1') || htmlSource.includes('scope-ui-logic.js?v=scope-participation-policy-engine-1'));
