...
(async () => {
  ...
  await record('07 administration Participation, schema et cache-bust sont presents', () => {
    ...
    assert.ok(htmlSource.includes('scope.css?v=scope-event-configuration-binding-migration-6') || htmlSource.includes('scope.css?v=scope-referentials-usage-traceability-active-filter-repair-5-3') || htmlSource.includes('scope.css?v=scope-configuration-formation-ux-referentials-finish-5') || htmlSource.includes('scope.css?v=scope-event-configuration-binding-ux-repair-4') || htmlSource.includes('scope.css?v=scope-configuration-policy-runtime-performance-root-repair-3') || htmlSource.includes('scope.css?v=scope-configuration-formation-ux-import-performance-repair-2') || htmlSource.includes('scope.css?v=scope-generic-event-session-policy-architecture-1') || htmlSource.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope.css?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-ui-logic.js?v=scope-referentials-usage-traceability-active-filter-repair-5-3') || htmlSource.includes('scope-ui-logic.js?v=scope-configuration-formation-ux-referentials-finish-5') || htmlSource.includes('scope-ui-logic.js?v=scope-event-configuration-binding-ux-repair-4') || htmlSource.includes('scope-ui-logic.js?v=scope-configuration-policy-runtime-performance-root-repair-3') || htmlSource.includes('scope-ui-logic.js?v=scope-configuration-formation-ux-import-performance-repair-2') || htmlSource.includes('scope-ui-logic.js?v=scope-generic-event-session-policy-architecture-1') || htmlSource.includes('scope-ui-logic.js?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-api.js?v=scope-event-configuration-binding-migration-6') || htmlSource.includes('scope-api.js?v=scope-referentials-usage-traceability-active-filter-repair-5-3') || htmlSource.includes('scope-api.js?v=scope-configuration-formation-ux-referentials-finish-5') || htmlSource.includes('scope-api.js?v=scope-event-configuration-binding-ux-repair-4') || htmlSource.includes('scope-api.js?v=scope-configuration-policy-runtime-performance-root-repair-3') || htmlSource.includes('scope-api.js?v=scope-configuration-formation-ux-import-performance-repair-2') || htmlSource.includes('scope-api.js?v=scope-generic-event-session-policy-architecture-1') || htmlSource.includes('scope-api.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope-api.js?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-ui.js?v=scope-event-configuration-binding-migration-6') || htmlSource.includes('scope-ui.js?v=scope-referentials-usage-traceability-active-filter-repair-5-3') || htmlSource.includes('scope-ui.js?v=scope-configuration-formation-ux-referentials-finish-5') || htmlSource.includes('scope-ui.js?v=scope-event-configuration-binding-ux-repair-4') || htmlSource.includes('scope-ui.js?v=scope-configuration-policy-runtime-performance-root-repair-3') || htmlSource.includes('scope-ui.js?v=scope-configuration-formation-ux-import-performance-repair-2') || htmlSource.includes('scope-ui.js?v=scope-generic-event-session-policy-architecture-1') || htmlSource.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope-ui.js?v=scope-participation-policy-engine-1'));
  });
