...
(async () => {
  ...
  await record('07 administration Participation, schema et cache-bust sont presents', () => {
    ...
    assert.ok(htmlSource.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope.css?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-ui-logic.js?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-api.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope-api.js?v=scope-participation-policy-engine-1'));
    assert.ok(htmlSource.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSource.includes('scope-ui.js?v=scope-participation-policy-engine-1'));
  });
