...
(async () => {
  ...
  await record('11 — cache EVENT-3', () => {
    assert.ok(html.includes('assets/css/scope.css?v=scope-ux-event-3') || html.includes('assets/css/scope.css?v=scope-design-2'));
    assert.ok(html.includes('scope-ui.js?v=scope-ux-event-3') || html.includes('scope-ui.js?v=scope-design-2'));
