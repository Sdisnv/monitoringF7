...
(async () => {
  ...
  await record('11 — cache EVENT-3', () => {
    ...
    assert.ok(html.includes('scope-ui.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-ui.js?v=scope-login-visual-alignment-orion-1') || html.includes('scope-ui.js?v=scope-front-finition-1') || html.includes('scope-ui.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui.js?v=scope-domaines-rapports-close-1') || html.includes('scope-ui.js?v=scope-nav-convergence-1') || html.includes('scope-ui.js?v=scope-analyses-statistiques-1') || html.includes('scope-ui.js?v=scope-vigilance-nav-repair-1') || html.includes('scope-ui.js?v=scope-vigilance-participation-1') || html.includes('scope-ui.js?v=scope-cycles-pr-auto-1') || html.includes('scope-ui.js?v=scope-ux-event-3') || html.includes('scope-ui.js?v=scope-design-2') || html.includes('scope-ui.js?v=scope-design-2b') || html.includes('scope-ui.js?v=scope-design-2c') || html.includes('scope-ui.js?v=scope-design-2d') || html.includes('scope-ui.js?v=scope-event-design-a') || html.includes('scope-ui.js?v=scope-event-design-b') || html.includes('scope-ui.js?v=scope-event-design-c') || html.includes('scope-ui.js?v=scope-event-design-c1') || html.includes('scope-ui.js?v=scope-event-c4-finish') || html.includes('scope-ui.js?v=scope-event-c3-fix'));
    assert.ok(pkg.includes('scope-ux-event-3-tests.js'));
  });
