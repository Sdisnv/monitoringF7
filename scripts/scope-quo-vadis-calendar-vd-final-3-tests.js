...
assert.ok(/scope-quo-vadis-calendar-vd-final-[34]/.test(read('scope.html')) || /scope-quo-vadis-agenda-ux-[12]/.test(read('scope.html')) || /scope-quo-vadis-a-arbitrer-redesign-1/.test(read('scope.html')));
