...
const { createScopeParticipationReportingService, FORMATION_DOMAINES } = require('../netlify/lib/_scope-jsp-reporting');
const { computeTaux, validateCloture } = require('../netlify/lib/_scope-rules');
const { evaluateEligibility, filterAttendusEligibleAtDate, TYPES_PERIODE } = require('../netlify/lib/_scope-personnel');
const contract = require('../netlify/lib/_scope-core-contract');
const cycles = require('../netlify/lib/_scope-cycle-rules');
