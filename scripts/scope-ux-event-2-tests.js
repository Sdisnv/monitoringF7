...
record('09 — cache et suite', () => {
  if (html.includes('scope-pr-abc-close-r2')) {
    ...
    assert.ok(html.includes('assets/css/scope.css?v=scope-login-visual-alignment-orion-1') || html.includes('assets/css/scope.css?v=scope-login-1') || html.includes('assets/css/scope.css?v=scope-ux-event-2') || html.includes('assets/css/scope.css?v=scope-ux-event-3') || html.includes('assets/css/scope.css?v=scope-design-2') || html.includes('assets/css/scope.css?v=scope-design-2b') || html.includes('assets/css/scope.css?v=scope-design-2c') || html.includes('assets/css/scope.css?v=scope-design-2d') || html.includes('assets/css/scope.css?v=scope-event-design-a') || html.includes('assets/css/scope.css?v=scope-event-design-b') || html.includes('assets/css/scope.css?v=scope-event-design-c') || html.includes('assets/css/scope.css?v=scope-event-design-c1') || html.includes('scope-event-c4-finish') || html.includes('scope-event-c3-fix') || html.includes('assets/css/scope.css?v=scope-participation-policy-engine-1'));
    assert.ok(html.includes('scope-ui.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-ui.js?v=scope-event-close-ux-formateur-1') || html.includes('scope-ui.js?v=scope-login-visual-alignment-orion-1') || html.includes('scope-ui.js?v=scope-front-finition-1') || html.includes('scope-ui.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui.js?v=scope-domaines-rapports-close-1') || html.includes('scope-ui.js?v=scope-nav-convergence-1') || html.includes('scope-ui.js?v=scope-analyses-statistiques-1') || html.includes('scope-ui.js?v=scope-vigilance-nav-repair-1') || html.includes('scope-ui.js?v=scope-vigilance-participation-1') || html.includes('scope-ui.js?v=scope-cycles-pr-auto-1') || html.includes('scope-ui.js?v=scope-reports-pdf-specialisation-repair-1') || html.includes('scope-ui.js?v=scope-events-render-report-repair-1') || html.includes('scope-ui.js?v=scope-events-access-r1') || html.includes('scope-ui.js?v=scope-login-1') || html.includes('scope-ui.js?v=scope-ux-event-2') || html.includes('scope-ui.js?v=scope-ux-event-3') || html.includes('scope-ui.js?v=scope-design-2') || html.includes('scope-ui.js?v=scope-design-2b') || html.includes('scope-ui.js?v=scope-design-2c') || html.includes('scope-ui.js?v=scope-design-2d') || html.includes('scope-ui.js?v=scope-event-design-a') || html.includes('scope-ui.js?v=scope-event-design-b') || html.includes('scope-ui.js?v=scope-event-design-c') || html.includes('scope-ui.js?v=scope-event-design-c1') || html.includes('scope-ui.js?v=scope-event-c4-finish') || html.includes('scope-ui.js?v=scope-event-c3-fix') || html.includes('scope-ui.js?v=scope-participation-policy-engine-1'));
  assert.ok(pkg.includes('scope-ux-event-2-tests.js'));
});
