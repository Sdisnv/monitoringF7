...
(async () => {
  await record('01 — menu contient Accueil explicite', async () => {
    ...
    assert.ok(L.buildSidebarNav(arbre, { screen: 'accueil', nav: 'accueil' }).primary.some((item) => item.id === 'accueil' && item.href === '#/accueil' && item.current));
  });
  ...
  await record('06 — Administration structurée', async () => {
    ['Administration', 'Application', 'Imports', 'Accès', 'À propos'].forEach((label) => assert.ok(ui.includes(label)));
    assert.ok(logicSource.includes('#/reglages/apropos'));
  ...
  await record('16 — logo SCOPE agrandi R2', async () => {
    ...
    assert.ok(html.includes('scope-ui-logic.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-ui-logic.js?v=scope-generic-exercise-sessions-1') || html.includes('scope-ui-logic.js?v=scope-pr-abc-close-r2') || html.includes('scope-ui-logic.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui-logic.js?v=scope-nav-convergence-1') || html.includes('scope-ui-logic.js?v=scope-events-access-r1') || html.includes('scope-ui-logic.js?v=scope-login-1') || html.includes('scope-ui-logic.js?v=scope-participation-policy-engine-1'));
    ...
    assert.ok(html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-pr-abc-close-r2') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-login-visual-alignment-orion-1') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-login-1') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-event-c3-fix') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-event-design-c1') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-event-design-c') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-event-design-b') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-event-design-a') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-design-2d') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-design-2c') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-design-2b') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-design-2') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-ux-event-1') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-ux-event-2') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-ux-event-3') || html.includes('scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope.css?v=scope-participation-policy-engine-1'));
    assert.ok(html.includes('scope-personnel-display.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-personnel-display.js?v=scope-objectifs-participation-1-r1') || html.includes('scope-personnel-display.js?v=scope-table-sorting-visual-ux-2') || html.includes('scope-personnel-display.js?v=scope-deleted-event-single-source-of-truth-11-2'));
    ...
    assert.ok(html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-close-ux-formateur-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-generic-exercise-sessions-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-pr-abc-close-r2') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-login-visual-alignment-orion-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-front-finition-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-domaines-rapports-close-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-nav-convergence-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-analyses-statistiques-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-vigilance-nav-repair-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-vigilance-participation-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-cycles-pr-auto-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-reports-pdf-specialisation-repair-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-events-render-report-repair-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-events-access-r1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-login-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-c3-fix') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-design-c1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-design-c') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-design-b') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-event-design-a') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-design-2d') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-design-2c') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-design-2b') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-design-2') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-ux-event-1') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-ux-event-2') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-ux-event-3') || html.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('scope-ui.js?v=scope-participation-policy-engine-1'));
  });
