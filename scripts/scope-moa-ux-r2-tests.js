...
(async () => {
  ...
  await record('16 — logo SCOPE agrandi R2', async () => {
    ...
    assert.ok(html.includes('scope-ui-logic.js?v=scope-pr-abc-close-r2') || html.includes('scope-ui-logic.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui-logic.js?v=scope-nav-convergence-1') || html.includes('scope-ui-logic.js?v=scope-events-access-r1') || html.includes('scope-ui-logic.js?v=scope-login-1'));
