...
(async () => {
  ...
  await record('16 — logo SCOPE agrandi R2', async () => {
    ...
    assert.ok(html.includes('scope-ui-logic.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-ui-logic.js?v=scope-generic-exercise-sessions-1') || html.includes('scope-ui-logic.js?v=scope-pr-abc-close-r2') || html.includes('scope-ui-logic.js?v=scope-admin-rbac-doc-1') || html.includes('scope-ui-logic.js?v=scope-nav-convergence-1') || html.includes('scope-ui-logic.js?v=scope-events-access-r1') || html.includes('scope-ui-logic.js?v=scope-login-1'));
    ...
    assert.ok(html.includes('scope.css?v=scope-pr-abc-close-r2') || html.includes('scope.css?v=scope-login-visual-alignment-orion-1') || html.includes('scope.css?v=scope-login-1') || html.includes('scope.css?v=scope-event-c3-fix') || html.includes('scope.css?v=scope-event-design-c1') || html.includes('scope.css?v=scope-event-design-c') || html.includes('scope.css?v=scope-event-design-b') || html.includes('scope.css?v=scope-event-design-a') || html.includes('scope.css?v=scope-design-2d') || html.includes('scope.css?v=scope-design-2c') || html.includes('scope.css?v=scope-design-2b') || html.includes('scope.css?v=scope-design-2') || html.includes('scope.css?v=scope-ux-event-1') || html.includes('scope.css?v=scope-ux-event-2') || html.includes('scope.css?v=scope-ux-event-3'));
