...
(async () => {
  ...
  await record('16 — logo SCOPE agrandi R2', async () => {
    ...
    assert.ok(html.includes('scope-personnel-display.js?v=scope-jsp-excuse-motifs-1') || html.includes('scope-personnel-display.js?v=scope-objectifs-participation-1-r1') || html.includes('scope-personnel-display.js?v=scope-table-sorting-visual-ux-2'));
