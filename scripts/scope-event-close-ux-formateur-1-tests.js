...
(async () => {
  ...
  await record('08 cache-bust SCOPE du lot', () => {
    assert.ok(htmlSrc.includes('scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || htmlSrc.includes('scope-ui.js?v=scope-jsp-excuse-motifs-1') || htmlSrc.includes('scope-ui.js?v=scope-event-close-ux-formateur-1') || htmlSrc.includes('scope-ui.js?v=scope-participation-policy-engine-1'));
  });
