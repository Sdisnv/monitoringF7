...
(async () => {
  ...
  await record('06 — cache-bust SCOPE visuel uniquement', () => {
    ...
    assert.ok(html.includes('assets/js/scope-ui.js?v=scope-generic-exercise-sessions-1') || html.includes('assets/js/scope-ui.js?v=scope-pr-abc-close-r2') || html.includes('assets/js/scope-ui.js?v=scope-login-visual-alignment-orion-1'));
