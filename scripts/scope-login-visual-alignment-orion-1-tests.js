...
(async () => {
  ...
  await record('06 — cache-bust SCOPE visuel uniquement', () => {
    ...
    assert.ok(html.includes('assets/css/scope.css?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('assets/css/scope.css?v=scope-pr-abc-close-r2') || html.includes('assets/css/scope.css?v=scope-login-visual-alignment-orion-1') || html.includes('assets/css/scope.css?v=scope-participation-policy-engine-1'));
    assert.ok(html.includes('assets/js/scope-ui.js?v=scope-multisession-v2-close-reopen-report-ux-3') || html.includes('assets/js/scope-ui.js?v=scope-jsp-excuse-motifs-1') || html.includes('assets/js/scope-ui.js?v=scope-event-close-ux-formateur-1') || html.includes('assets/js/scope-ui.js?v=scope-generic-exercise-sessions-1') || html.includes('assets/js/scope-ui.js?v=scope-pr-abc-close-r2') || html.includes('assets/js/scope-ui.js?v=scope-login-visual-alignment-orion-1') || html.includes('assets/js/scope-ui.js?v=scope-participation-policy-engine-1'));
