...
assert.ok(/scope-quo-vadis-calendar-vd-final-4/.test(read('scope.html')) || /scope-quo-vadis-agenda-ux-[123]/.test(read('scope.html')) || /scope-quo-vadis-toutes-activites-ux-[12]/.test(read('scope.html')));
