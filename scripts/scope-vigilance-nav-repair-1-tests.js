...
(async () => {
  ...
  await record('04 — cache-bust route vers le JS corrigé', async () => {
    assert.ok(htmlSource.includes('scope-ui.js?v=scope-domaines-rapports-close-1') || htmlSource.includes('scope-ui.js?v=scope-nav-convergence-1') || htmlSource.includes('scope-ui.js?v=scope-analyses-statistiques-1') || htmlSource.includes('scope-ui.js?v=scope-vigilance-nav-repair-1'));
  });
