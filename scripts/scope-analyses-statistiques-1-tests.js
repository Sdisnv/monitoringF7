...
(async () => {
  ...
  await record('06 — cache et suite branchés', async () => {
    assert.ok(htmlSource.includes('scope-ui.js?v=scope-domaines-rapports-close-1') || htmlSource.includes('scope-ui.js?v=scope-nav-convergence-1') || htmlSource.includes('scope-ui.js?v=scope-analyses-statistiques-1'));
