...
(async () => {
  ...
  await record('08 — cache-buster REPAIR-2 et protections moteurs', () => {
    ...
    const serviceSrc = read('netlify/lib/_scope-service.js');
    ok(html.includes('scope-configuration-formation-ux-referentials-finish-5') || html.includes('scope-event-configuration-binding-ux-repair-4') || html.includes('scope-configuration-policy-runtime-performance-root-repair-3') || html.includes('scope-configuration-formation-ux-import-performance-repair-2'), 'cache-buster formation repair présent');
