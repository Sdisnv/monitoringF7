...
(async () => {
  ...
  await record('10 - cache bust et suite dediee ADMIN-RBAC-DOC-1 branches', async () => {
    assert.ok(htmlSource.includes('scope-ui-logic.js?v=scope-generic-exercise-sessions-1') || htmlSource.includes('scope-ui-logic.js?v=scope-pr-abc-close-r2') || htmlSource.includes('scope-ui-logic.js?v=scope-admin-rbac-doc-1'));
