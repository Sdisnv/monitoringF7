...
record('04 — tri Grade: hiérarchie inversée, Nom ASC dans le grade', () => {
  ...
  assert.deepStrictEqual(desc, [
    ...
    assert.ok(html.includes('scope-event-close-ux-formateur-1') || html.includes('scope-event-design-c1') || html.includes('scope-event-design-c2') || html.includes('scope-event-c3-fix'));
});
